...
import com.lambdaschool.datapersistencesprintchallenge.model.FavouriteMoviesViewModel
...
class FavoritesActivity : AppCompatActivity() {
    ...
    class UpdateAsyncTask(viewModel: FavouriteMoviesViewModel) : AsyncTask<FavoriteMovie, Void, Unit>() {
    ...
    class DeleteAsyncTask(viewModel: FavouriteMoviesViewModel) : AsyncTask<FavoriteMovie, Void, Unit>() {
    ...
    class ReadAllAsyncTask(activity: FavoritesActivity) : AsyncTask<Void, Void, LiveData<List<FavoriteMovie>>?>() {
